...
function displayKategori(){
    ...
    <div class="col">
        <div id="${0}" class="card shadow h-100" onclick="pilihKategori(this.id)">
            <div class="card-body" style="padding-top:70px; padding-bottom:70px">
                <h5 class="card-title" style="font-size:14px">${umkmDatabase.pertanian.nama_kategori}</h5>
            </div>
        </div>
    </div>
    <div class="col">
        <div id="${1}" class="card shadow h-100" onclick="pilihKategori(this.id)">
            <div class="card-body" style="padding-top:70px; padding-bottom:70px">
                <h5 class="card-title" style="font-size:14px">${umkmDatabase.peternakan.nama_kategori}</h5>
            </div>
        </div>
    </div>
    <div class="col">
        <div id="${2}" class="card shadow h-100" onclick="pilihKategori(this.id)">
            <div class="card-body" style="padding-top:70px; padding-bottom:70px">
                <h5 class="card-title" style="font-size:14px">${umkmDatabase.kerajinan.nama_kategori}</h5>
            </div>
        </div>
    </div>
    <div class="col">
        <div id="${3}" class="card shadow h-100" onclick="pilihKategori(this.id)">
            <div class="card-body" style="padding-top:70px; padding-bottom:70px">
                <h5 class="card-title" style="font-size:14px">${umkmDatabase.wisata.nama_kategori}</h5>
            </div>
        </div>
    </div>
    `;
...
function pilihKategori(idKategori){
    ...
    if(idKategori == 0){
        databaseDipilih = umkmDatabase.pertanian.produk;
    };
    if(idKategori == 1){
        databaseDipilih = umkmDatabase.peternakan.produk;
    };
    if(idKategori == 2){
        databaseDipilih = umkmDatabase.kerajinan.produk;
    };
    if(idKategori == 3){
        databaseDipilih = umkmDatabase.wisata.produk;
    }
